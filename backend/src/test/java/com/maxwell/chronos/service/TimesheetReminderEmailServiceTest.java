...
class TimesheetReminderEmailServiceTest {
    @Test void sendsToWorkEmailWithPeriodAndAppLink() {
        ...
        var service = new TimesheetReminderEmailService(provider, "chronos@example.com", "https://chronos.example.com/");
    ...
    @Test void missingConfigurationDoesNotPretendToSend() {
        ObjectProvider<JavaMailSender> provider = mock(ObjectProvider.class);
        var service = new TimesheetReminderEmailService(provider, "", "https://chronos.example.com");
